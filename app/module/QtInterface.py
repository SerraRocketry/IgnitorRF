from PySide6.QtCore import (QCoreApplication, Qt, QMetaObject, QRect)
from PySide6.QtGui import (QFont, QCursor, QTextCursor, QPixmap)
...
if hasattr(sys, '_MEIPASS'):
    image_path = os.path.join(sys._MEIPASS, 'assets/logo.png')
else:
